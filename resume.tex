...
\vbox{
  \halign{%
    ...
    state exam topics: \cr
    \indent Computer Science Foundations - undecidable problems \cr
    \indent Software System Foundations - graph algorithms, fast matrix multiplication \cr
    \indent Operating Systems - high speed networking \cr
    \indent Programming Languages - polyhedral compilation \cr
    \indent Formal Verification - first-order theories and decision procedures \cr
    \cr
...
\vbox{
  \halign{%
    ...
    standard: Javascript, PHP, SQL, (X)HTML, CSS \cr
...
\vbox{
  \halign{%
    ...
    Environment:        & {unix (linux, bsd), vim, ssh, tmux} \cr
  }
}
\vsep
\vbox{
...
\vbox{
  \halign{%
    ...
    category theory, functional programming, strong static typing, dependent types, formal verification, program analysis, computability, computational complexity, logic, theorem proving, sailing, snowboarding
    \cr
  }
}
